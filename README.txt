...
To correctly run the code, these folders and files are needed:
-iso2mesh-master
-homer2
-greyjet.mat
-vol2gm.mat
-Homework data provided

In Results.mat there are 3 files:
-remCh: the output of removeNoisyChannels
-HbO_timepoints and HbR_timepoints: these 2 are 2 struct that contain the reconstructed images at the selected time points
